...
public final class NameGenerator {
    ...
    static String[] pref = {"Ale", "Mar", "Vic", "Leo", "Dar", "Ja", "Je", "Ra", "Fa", "Lu"};
    static String[] mid = {"ri", "jan", "i", "ti", "", "thar", "nar", "ta", "vi", "roe", "in"};
    static String[] suf = {"dra", "dro", "na", "no", "tor", "", "do", "da", "er", "bow", "o", "ca", "sen"};
